...
import com.aqupd.customgui.gui.HandConfigScreen;
...
public class CustomHandGui implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        changeHandsKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "key.aqupd.changehands", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_5, "key.aqupd.categories.handgui"));
        openConfigKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "key.aqupd.configgui", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_4, "key.aqupd.categories.handgui"));
        resetHandsKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "key.aqupd.resethands", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_7, "key.aqupd.categories.handgui"));
        randomizeKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                "key.aqupd.randomize", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_6, "key.aqupd.categories.handgui"));
